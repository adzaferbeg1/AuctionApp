    ...
    <footer className="text-center text-white" >
      <div className="row footer">
        ...
        <div className="col footer-col">
          ...
          <span className="footer-dot" ><a href="https://www.facebook.com/AtlantBH/"><FaFacebookF style={footerSocialIcon} /></a></span>
          <span className="footer-dot" ><a href="https://instagram.com/atlantbh?lang=en"><TiSocialInstagram style={footerSocialIcon} /></a></span>
          <span className="footer-dot" ><a href="https://twitter.com/atlantbh?lang=en"><FaTwitter style={footerSocialIcon} /></a></span>
          <span className="footer-dot" ><a href="https://www.atlantbh.com/"><TiSocialGooglePlus style={footerSocialIcon} /></a></span>
        ...
        <div className="col footer-col last-footer-col">
          ...
          <div className="input-group">
            <div className="form-outline">
              <input type="email" className="form-control" id="email-input" placeholder="Your Email address" />
            </div>
